Build :
./configure --host=arm-linux-gnueabihf --prefix=$PWD/_install --enable-shared -disable-static --disable-video --without-x --without-xshm --without-xv --without-jpeg --without-imagemagick --without-gtk --without-python --without-qt
